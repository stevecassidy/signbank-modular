...
#change_page = Permission.objects.get(codename='change_flatpage', content_type__model__exact='page')
#add_page = Permission.objects.get(codename='add_flatpage', content_type__model__exact='page')
